...
class _CFNode:
    ...
    def insert_cf_subcluster(self, subcluster, splited):
...
class Birch(ClusterMixin, TransformerMixin, BaseEstimator):
    ...
    * Roberto Perdisci
    ...
    def fit(self, X, y=None):
        ...
        return self._fit(X, [True])

    def _fit(self, X, splited):
        ...
        for sample in iter_func(X):
            ...
            split = self.root_.insert_cf_subcluster(subcluster, splited)
    ...
    def partial_fit(self, X=None, y=None):
        ...
        if X is None:
            ...
            self._check_fit(X)
            splited = [False]
            return self._fit(X, splited), splited
